...
import Cardano.Ledger.Shelley.LedgerState (ShelleyPPUPState, keyTxRefunds, totalTxDeposits, PPUPState)
...
utxoTransition = do
  ...
  pure $! Shelley.updateShelleyUTxOState u txb depositChange ppup'
