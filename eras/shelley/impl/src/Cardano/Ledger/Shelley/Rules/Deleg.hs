  ...
  case c of
    DCertDeleg (RegKey hk) -> do
      ...
      let u1 = dsUnified ds
          ...
          u2 = Rewards u1 UM.∪ (hk, RDPair (UM.CompactCoin 0) deposit)
          u3 = Ptrs u2 UM.∪ (ptr, hk)
      pure $ (ds {dsUnified = u3}) -- payKeyDeposit hk pp (ds {dsUnified = u3})
    DCertDeleg (DeRegKey hk) -> do
      ...
      let u0 = dsUnified ds
          ...
          u4 = (ds {dsUnified = u3}) -- refundKeyDeposit hk (ds {dsUnified = u3})
      pure u4
